...
import { Layout, Move, RotateCcw, Eye, Save, Settings, Grid, Smartphone, Monitor } from 'lucide-react';
...
export const LayoutEditor: React.FC = () => {
  ...
  const applyLayoutSettings = (layoutSettings: LayoutSettings) => {
    ...
    root.style.setProperty('--shadow', shadowValues[layoutSettings.shadows as keyof typeof shadowValues]);
            ...
            <div className="bg-gradient-to-r from-cyan-600 to-cyan-700 p-6 text-white">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <Layout size={24} />
                  <h2 className="text-2xl font-bold">Éditeur de Mise en Page</h2>
                  {isLayoutMode && (
            ...
            <div className="p-6 max-h-[calc(95vh-200px)] overflow-y-auto">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => updateSetting('containerMaxWidth', e.target.value)}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateSetting('sectionPadding', `${e.target.value}px`)}
                        className="w-full"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateSetting('gridGaps', `${e.target.value}px`)}
                        className="w-full"
                      />
                      <div className="text-sm text-gray-600 mt-1">
                        {settings.gridGaps}
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h4 className="font-medium text-gray-900 mb-3">Aperçu des styles</h4>
                      ...
                      <div className="space-y-3">
                        <div 
                          ...
                          style={{ 
                            ...
                            boxShadow: settings.shadows !== 'none' ? 'var(--shadow)' : 'none'
                          }}
                        >
              ...
              <div className="mt-8 p-4 bg-cyan-50 border border-cyan-200 rounded-lg">
                ...
                <ul className="text-cyan-700 text-sm space-y-1">
                  <li>• Activez le mode édition pour voir les contours des éléments</li>
                  <li>• Utilisez les vues d'appareils pour tester la responsivité</li>
